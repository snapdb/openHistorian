...
public class DEFComputationAdapter : VIFCalculatedMeasurementBase
{
    ...
    private static string m_studyIntervalStart = "StudyIntervalStart";
    ...
    private MaximumMagnitude GetMaximumMagnitude(Matrix<double> values, string[] lineIds, string[] substations)
    {
        ...
        // Disagreement between this and the matlab code, might be difference on how matlab designs its prototype lp filter...
