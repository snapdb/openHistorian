...
//// Define LineMeasurements as a pair of PhasorMeasurements representing measurement keys for a voltage and an associated current phasor:
//using LineMeasurements = System.Tuple</* PhasorMeasurements, PhasorMeasurements >*/
//    System.Tuple<Gemstone.Timeseries.MeasurementKey, Gemstone.Timeseries.MeasurementKey>, System.Tuple<Gemstone.Timeseries.MeasurementKey, Gemstone.Timeseries.MeasurementKey>>;

//// Define PhasorMeasurements as a pair of measurement keys representing an angle and a magnitude, i.e., Tuple<MeasurementKey, MeasurementKey>:
//using PhasorMeasurements = System.Tuple<Gemstone.Timeseries.MeasurementKey, Gemstone.Timeseries.MeasurementKey>;
...
//public class SampleActionAdapter : ActionAdapterBase
//{
//    #region [ Members ]
