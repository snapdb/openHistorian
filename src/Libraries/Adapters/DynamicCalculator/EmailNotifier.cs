...
public class EmailNotifier : DynamicCalculator
{
    ...
    {
        get => m_mailClient.CcRecipients ?? string.Empty;
    ...
    {
        get => m_mailClient.BccRecipients ?? string.Empty;
    ...
    {
        get => m_mailClient.Subject ?? string.Empty;
    ...
    {
        get => m_mailClient.UserName ?? string.Empty;
    ...
    {
        get => m_mailClient.Password ?? string.Empty;
