...
public class FrequencyExcursion : CalculatedMeasurementBase
{
    ...
    private readonly List<double> m_frequencies = [];   // Frequency measurement values
    ...
    public override void Initialize()
    {
        ...
        if (InputMeasurementKeys is null || InputMeasurementKeyTypes is null)
            throw new InvalidOperationException("No input measurements were specified for the frequency excursion detector.");
