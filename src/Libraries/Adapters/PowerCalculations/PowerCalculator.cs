...
[UIResource("AdaptersUI", $".{nameof(PowerCalculations)}.{nameof(PowerCalculator)}.{nameof(PowerCalculations)}.{nameof(PowerCalculator)}.js", $"{nameof(PowerCalculations)}.{nameof(PowerCalculator)}.js")]
