...
public abstract class PhasorDataConcentratorBase : ActionAdapterBase
{
    ...
    /// <summary>
    /// Gets or sets the <see cref="Gemstone.PhasorProtocols.DataFormat"/> defined for this <see cref="PhasorDataConcentratorBase"/>.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Gets or sets the <see cref="Gemstone.PhasorProtocols.CoordinateFormat"/> defined for this <see cref="PhasorDataConcentratorBase"/>.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Gets the protocol independent <see cref="Gemstone.PhasorProtocols.Anonymous.ConfigurationFrame"/> defined for this <see cref="PhasorDataConcentratorBase"/>.
    /// </summary>
    ...
    /// </summary>
    protected Dictionary<MeasurementKey, SignalReference[]>? SignalReferences => Interlocked.CompareExchange(ref m_signalReferences, null, null);
    ...
    private void EstablishPublicationChannel()
    {
        ...
        PublishChannel = m_dataChannel is null && m_commandChannel is not null ? m_commandChannel : m_dataChannel;
    }
        ...
        foreach (DataRow measurementRow in measurementRows)
        {
            ...
            try
            {
                ...
                if (signal.CellIndex > -1 || isQualityFlagsMeasurement)
                {
                    ...
                    signalReferences.AddOrUpdate(measurementKey, _ => [signal], (_, signals) =>
                    {
    ...
    public override void QueueMeasurementsForProcessing(IEnumerable<IMeasurement> measurements)
    {
        ...
        List<IMeasurement> inputMeasurements = [];
    ...
    protected virtual void CacheConfigurationFrame(IConfigurationFrame configurationFrame, string name)
    {
        ...
        try
        {
            ...
            Gemstone.PhasorProtocols.Anonymous.ConfigurationFrame.Cache(configurationFrame, ex => OnProcessException(MessageLevel.Info, ex), name);
        }
        catch (Exception ex)
        {
