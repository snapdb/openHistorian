...
public sealed class ConfigurationErrorFrame : IConfigurationFrame
{
    ...
    ConfigurationCellCollection IConfigurationFrame.Cells => default!;
    ...
    object IChannelFrame.Cells => default!;
    ...
    UnixTimeTag IChannelFrame.TimeTag => default!;

    Dictionary<string, string> IChannel.Attributes => default!;
    ...
    ConcurrentDictionary<MeasurementKey, IMeasurement> IFrame.Measurements => default!;
