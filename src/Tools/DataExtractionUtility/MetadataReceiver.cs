...
namespace openVisN
{
    ...
    internal sealed class MetadataRetriever : IDisposable
    {
        ...
        private void m_subscriber_MetaDataReceived(object sender, Gemstone.EventArgs<DataSet> e)
        {
        ...
        private void m_subscriber_ProcessException(object sender, Gemstone.EventArgs<Exception> e)
        {
