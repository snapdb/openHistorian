...
public class InitialDataset : Migration
{
    ...
    public override void Up()
    {
        ...
        Insert.IntoTable("SignalType")
            .Row(new { Name = "Current Magnitude", Acronym = "IPHM", Suffix = "PM", Abbreviation = "I", LongAcronym = "CurrentMagnitude", Source = "Phasor", EngineeringUnits = "Amps", LoadOrder = 0 })
            .Row(new { Name = "Current Phase Angle", Acronym = "IPHA", Suffix = "PA", Abbreviation = "IH", LongAcronym = "CurrentAngle", Source = "Phasor", EngineeringUnits = "Degrees", LoadOrder = 1 })
            .Row(new { Name = "Voltage Magnitude", Acronym = "VPHM", Suffix = "PM", Abbreviation = "V", LongAcronym = "VoltageMagnitude", Source = "Phasor", EngineeringUnits = "Volts", LoadOrder = 2 })
            .Row(new { Name = "Voltage Phase Angle", Acronym = "VPHA", Suffix = "PA", Abbreviation = "VH", LongAcronym = "VoltageAngle", Source = "Phasor", EngineeringUnits = "Degrees", LoadOrder = 3 })
            .Row(new { Name = "Frequency", Acronym = "FREQ", Suffix = "FQ", Abbreviation = "F", LongAcronym = "Frequency", Source = "PMU", EngineeringUnits = "Hz", LoadOrder = 4 })
            .Row(new { Name = "Frequency Delta (dF/dt)", Acronym = "DFDT", Suffix = "DF", Abbreviation = "DF", LongAcronym = "DfDt", Source = "PMU", EngineeringUnits = "", LoadOrder = 5 })
            .Row(new { Name = "Analog Value", Acronym = "ALOG", Suffix = "AV", Abbreviation = "AV", LongAcronym = "Analog", Source = "PMU", EngineeringUnits = "", LoadOrder = 6 })
            .Row(new { Name = "Status Flags", Acronym = "FLAG", Suffix = "SF", Abbreviation = "S", LongAcronym = "StatusFlags", Source = "PMU", EngineeringUnits = "", LoadOrder = 7 })
        ...
        Insert.IntoTable("Vendor")
            .Row(new { Acronym = "ABB", Name = "ABB", PhoneNumber = "", ContactEmail = "", URL = "http://www.abb.com/", LoadOrder = 1 })
            .Row(new { Acronym = "ARB", Name = "Arbiter", PhoneNumber = "", ContactEmail = "", URL = "http://www.arbiter.com/", LoadOrder = 2 })
            .Row(new { Acronym = "ART", Name = "Artemes", PhoneNumber = "", ContactEmail = "", URL = "http://www.artemes.org/", LoadOrder = 3 })
            .Row(new { Acronym = "ATK", Name = "Ametek", PhoneNumber = "", ContactEmail = "", URL = "http://www.ametek.com/", LoadOrder = 4 })
            .Row(new { Acronym = "BPA", Name = "Bonneville Power Administration", PhoneNumber = "", ContactEmail = "", URL = "http://www.bpa.gov/", LoadOrder = 5 })
            .Row(new { Acronym = "GE", Name = "General Electric", PhoneNumber = "", ContactEmail = "", URL = "http://www.ge.com/", LoadOrder = 6 })
            .Row(new { Acronym = "HWY", Name = "Hathaway", PhoneNumber = "", ContactEmail = "", URL = "http://www.qualitrolcorp.com/", LoadOrder = 7 })
            .Row(new { Acronym = "MAC", Name = "Macrodyne", PhoneNumber = "", ContactEmail = "", URL = "http://www.macrodyneusa.com/", LoadOrder = 8 })
            .Row(new { Acronym = "MTA", Name = "Mehtatech", PhoneNumber = "", ContactEmail = "", URL = "http://www.mehtatech.com/", LoadOrder = 9 })
            .Row(new { Acronym = "NPT", Name = "NxtPhase", PhoneNumber = "", ContactEmail = "", URL = "http://www.nxtphase.com/", LoadOrder = 10 })
            .Row(new { Acronym = "OTR", Name = "Other / Unspecified", PhoneNumber = "", ContactEmail = "", URL = "", LoadOrder = 11 })
            .Row(new { Acronym = "SEL", Name = "Schweitzer", PhoneNumber = "", ContactEmail = "", URL = "http://www.selinc.com/", LoadOrder = 12 })
            .Row(new { Acronym = "GPA", Name = "Grid Protection Alliance", PhoneNumber = "", ContactEmail = "", URL = "http://www.gridprotectionalliance.org/", LoadOrder = 13 })
            .Row(new { Acronym = "UTK", Name = "University of Tennessee, Knoxville", PhoneNumber = "", ContactEmail = "", URL = "http://www.utk.edu/", LoadOrder = 14 })
            .Row(new { Acronym = "SIE", Name = "Siemens", PhoneNumber = "", ContactEmail = "", URL = "http://www.siemens.com/", LoadOrder = 15 })
            .Row(new { Acronym = "EPG", Name = "Electric Power Group", PhoneNumber = "", ContactEmail = "", URL = "http://www.electricpowergroup.com/", LoadOrder = 16 });

        Insert.IntoTable("VendorDevice")
            .Row(new { VendorID = GetVendor("ARB"), Name = "Arbiter-1133A", Description = "Arbiter 1133A Power Sentinel", URL = "http://www.arbiter.com/catalog/power/1133a/1133a.php", LoadOrder = 0 })
            .Row(new { VendorID = GetVendor("ABB"), Name = "ABB-521", Description = "ABB RES521", URL = "http://library.abb.com/GLOBAL/SCOT/SCOT296.nsf/VerityDisplay/79B16E5CF206C79CC125712D0074AC6F/$File/1MRK511113-HEN_D_en_Phasor_Measurement_Terminal_RES_521.pdf", LoadOrder = 1 })
            .Row(new { VendorID = GetVendor("MTA"), Name = "Mehtatech 200", Description = "Metha Tech Transcan 2000 IED", URL = "http://www.mehtatech.com/pdf/IEDbrochMay02b.pdf", LoadOrder = 2 })
            .Row(new { VendorID = GetVendor("MAC"), Name = "Macrodyne 1690", Description = "Macrodyne 1690", URL = "http://www.macrodyneusa.com/model_1690.htm", LoadOrder = 3 })
            .Row(new { VendorID = GetVendor("SEL"), Name = "SEL-421", Description = "SEL-421 Relay", URL = "http://www.selinc.com/sel-421.htm", LoadOrder = 4 })
            .Row(new { VendorID = GetVendor("BPA"), Name = "BPA PDC", Description = "Bonneville Power Administration", URL = "http://www.bpa.gov/", LoadOrder = 5 })
            .Row(new { VendorID = GetVendor("HWY"), Name = "Hathaway IDM", Description = "Qualitrol Hathaway IDM Fault Recorder", URL = "http://www.qualitrolcorp.com/docs/home/IDM_Brochure.pdf", LoadOrder = 6 })
            .Row(new { VendorID = GetVendor("ATK"), Name = "Ametek", Description = "Ametek TR-2000 Multi-Function Recorder", URL = "http://www.ametekpower.com/products/sku.cfm?SKU_Id=12328", LoadOrder = 7 })
            .Row(new { VendorID = GetVendor("NPT"), Name = "NxtPhase", Description = "NxtPhase Telsa 2000 Fault Recorder", URL = "http://www.nxtphase.com/sub-products-relays-tesla-model-2000P.htm", LoadOrder = 8 })
            .Row(new { VendorID = GetVendor("OTR"), Name = "Other", Description = "Other Device", URL = "", LoadOrder = 9 })
            .Row(new { VendorID = GetVendor("SEL"), Name = "SEL-5077", Description = "SEL-5077 SynchroWAVe Server Software", URL = "http://www.selinc.com/synchrowave.htm", LoadOrder = 10 })
            .Row(new { VendorID = GetVendor("SEL"), Name = "SEL-451", Description = "SEL-451 Relay", URL = "http://www.selinc.com/sel-451.htm", LoadOrder = 11 })
            .Row(new { VendorID = GetVendor("SEL"), Name = "SEL-3306", Description = "SEL-3306 Synchrophasor Processor", URL = "http://synchrophasor.selinc.com/", LoadOrder = 12 })
            .Row(new { VendorID = GetVendor("GE"), Name = "GE N60", Description = "GE N60 Synchrophasor Measurement System", URL = "http://www.geindustrial.com/cwc/products?pnlid=6&famid=31&catid=234&id=n60&lang=en_US", LoadOrder = 12 })
            .Row(new { VendorID = GetVendor("GPA"), Name = "openPDC", Description = "Open Source Phasor Data Concentrator", URL = "http://www.openpdc.com/", LoadOrder = 13 })
            .Row(new { VendorID = GetVendor("GPA"), Name = "openHistorian", Description = "Open Source Phasor Historian", URL = "http://www.openHistorian.com/", LoadOrder = 14 })
            .Row(new { VendorID = GetVendor("GPA"), Name = "SIEGATE", Description = "Open Source Substation Phasor Data Concentrator", URL = "http://www.SIEGATE.com/", LoadOrder = 15 })
            .Row(new { VendorID = GetVendor("ART"), Name = "AM-4", Description = "AM4 Series PMU and PQ monitor", URL = "https://www.artemes.org/en_GB/shop/am-4-am4-series-33205?category=1#attr=2249", LoadOrder = 16 })
            .Row(new { VendorID = GetVendor("ART"), Name = "AM-5", Description = "AM5 Series PMU and PQ monitor", URL = "https://www.artemes.org/en_GB/shop/am-5-serie-am5-33204?category=1#attr=2253,70,73,75", LoadOrder = 17 })
            .Row(new { VendorID = GetVendor("UTK"), Name = "FNET", Description = "UTK FNET Device", URL = "", LoadOrder = 18 })
            .Row(new { VendorID = GetVendor("SEL"), Name = "SEL-3373", Description = "SEL-3373 Synchrophasor Data Concentrator", URL = "http://www.selinc.com/SEL-3373/", LoadOrder = 19 })
            .Row(new { VendorID = GetVendor("SIE"), Name = "SIMEAS R-PMU", Description = "7KE6100 Digital Fault Recorder & PMU", URL = "http://www.energy.siemens.com/mx/en/automation/power-transmission-distribution/power-quality/simeas-r-pmu.htm", LoadOrder = 20 })
            .Row(new { VendorID = GetVendor("EPG"), Name = "ePDC", Description = "ePDC & eSPDC", URL = "http://www.electricpowergroup.com/solutions/epdc/index.html", LoadOrder = 21 });
    }
